...
interface ProviderRepository {
    ...
    suspend fun getProviders(): Resource<List<ServiceProvider>>
    suspend fun getProviderDetails(providerId: String): Resource<ServiceProvider>
    suspend fun uploadFile(uri: Uri, path: String, mimeType: String?): Resource<String>
    ...
    suspend fun addPortfolioImage(uid: String, uri: Uri): Resource<Unit>
    suspend fun removePortfolioImage(uid: String, imageUrl: String): Resource<Unit>
    suspend fun updatePortfolioVideo(uid: String, uri: Uri): Resource<Unit>
    suspend fun removePortfolioVideo(uid: String): Resource<Unit>

    // --- NEW TESTING & LOGIC FUNCTIONS ---
    suspend fun generateDummyBookings(providerId: String): Resource<Unit>
