...
fun AppNavigation() {
    ...
    NavHost(
        ...
        // UPDATED: Pass the root navController to ProviderMainScreen
        composable(route = Route.PROVIDER_HOME) {
            ProviderMainScreen(rootNavController = navController)
        }
    }
}
...
fun NavGraphBuilder.authGraph(navController: NavHostController) {
    navigation(
        ...
        composable(Route.PROVIDER_EDIT_SERVICES) {
            ProviderEditServicesScreen(navController = navController)
        }
